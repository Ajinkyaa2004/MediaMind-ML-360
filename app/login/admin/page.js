...
export default function AdminLoginPage() {
  ...
  return (
    <div
      className={`${plusJakartaSans.className} relative flex flex-col justify-between h-screen w-full overflow-hidden`}
    >
      ...
      <footer
        className="text-center py-3 text-sm mt-6"
        style={{ color: "GrayText" }}
      >
        © {new Date().getFullYear()} MediaMind ML 360 · Built with ❤️ by Team
        Ajinkya, Praveen and Rudra.
      </footer>
